...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var versionStr = "ME v" + MainMenuState.plusEngineVersion + " | " + SONG.song + " (" + Difficulty.getString() + ")";
		versionText = new FlxText(0, -50, FlxG.width, versionStr, 14);
		versionText.setFormat(Paths.font("Ubuntu-MediumItalic.ttf"), 14, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		timeTxt.setFormat(Paths.font("Ubuntu-Bold.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("Ubuntu-Bold.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
